                ...
                <div className="w-1/3 flex flex-col justify-center items-center border border-zinc-200 py-8 rounded-lg shadow-md">
                    <div className="lg:w-3/4 w-full trhide">
                        ...
                        <div className="flex flex-col pt-4">
                            <label htmlFor="name" className="font-PoppinsRegular text-sm text-zinc-800 pb-2 pl-1">Name</label>
                            <input {...register("name", { required: true })} type="text" id="name" placeholder="Enter name" className="font-PoppinsRegular text-base p-2 border border-gray-300 rounded shadow-sm mb-4 placeholder:text-xs placeholder:text-zinc-400 focus:outline-primary-1" />
                            <label htmlFor="email" className="font-PoppinsRegular text-sm text-zinc-800 pb-2 pl-1">Email</label>
                            <input {...register("email", { required: true })} type="email" id="email" placeholder="Enter email" className="font-PoppinsRegular text-base p-2 border border-gray-300 rounded shadow-sm mb-4 placeholder:text-xs placeholder:text-zinc-400 focus:outline-primary-1" />
                            ...
                            <div className="flex justify-center py-2">
                                <p className="font-PoppinsRegular text-xs text-zinc-800">
                                    Already have an account? <Link className="text-primary-1" href="/login">Login</Link>
                                </p>
                            </div>
                        </div>
                    </div>
